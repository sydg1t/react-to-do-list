...
class ToDoList extends React.Component {
  ...
  fetchTasks() {
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1140").then(checkStatus).then(json).then((response) => {
  ...
  handleSubmit(event) {
    ...
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1140", {
      method: "POST",
      mode: "cors",
  ...
  deleteTask(id) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=1140`, {
      method: "DELETE",
      mode: "cors",
    }).then(checkStatus).then(json).then((data) => {
      this.fetchTasks();
  ...
  toggleComplete(id, completed) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=1140`, {
      method: "PUT",
      mode: "cors",
    }).then(checkStatus).then(json).then((data) => {
      this.fetchTasks();
      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            ...
            <div className="mt-3">
              <label>
                <input type="checkbox" name="all" checked={filter === "all"}
